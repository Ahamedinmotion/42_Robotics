...
let toastEmitter: (message: string, type?: "success" | "error") => void = () => {};
		...
		<ToastContext.Provider value={{ toast: showToast }}>
			...
			<div className="fixed bottom-16 right-4 z-[60] flex flex-col gap-2">
				{toasts.map((t) => (
					<div
						key={t.id}
						className={`animate-slide-in rounded-lg px-4 py-2 text-sm font-medium shadow-lg transition-all ${t.type === "success"
